...
export async function usersUpdateUser(
    ...
    >
> {
    const input$: operations.UpdateUserRequest = {
        apiKey: apiKey,
    ...
    const context = { operationID: "updateUser", oAuth2Scopes: [], securitySource: null };
    ...
    const [result$] = await m$.match<
        ...
        | RequestTimeoutError
        | ConnectionError
    >(m$.json(200, operations.UpdateUserResponseBody$inboundSchema))(response);
    if (!result$.ok) {
        return result$;
    }
