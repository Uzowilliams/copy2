 ...
 * Get a single topic
 */
export async function topicsGetTopic(
    client$: SDKCore,
    apiKey: string,
    apiUsername: string,
    id: string,
...
> {
    ...
    const context = { operationID: "getTopic", oAuth2Scopes: [], securitySource: null };
    ...
    const [result$] = await m$.match<
        ...
        | RequestTimeoutError
        | ConnectionError
    >(m$.json(200, operations.GetTopicResponseBody$inboundSchema))(response);
    if (!result$.ok) {
        return result$;
    }
