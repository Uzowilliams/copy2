...
export class Groups extends ClientSDK {
    ...
    async addGroupMembers(
        ...
        return unwrapAsync(groupsAddGroupMembers(this, id, requestBody, options));
    }
    ...
    async createGroup(
        ...
        return unwrapAsync(groupsCreateGroup(this, request, options));
    }
     ...
     * Get a group
     */
    async getGroup(id: string, options?: RequestOptions): Promise<operations.GetGroupResponseBody> {
        return unwrapAsync(groupsGetGroup(this, id, options));
    }
    ...
    async listGroupMembers(
        ...
        return unwrapAsync(groupsListGroupMembers(this, id, options));
    }

    /**
     * List groups
     */
    async listGroups(options?: RequestOptions): Promise<operations.ListGroupsResponseBody> {
        return unwrapAsync(groupsListGroups(this, options));
    }
    ...
    async removeGroupMembers(
        ...
        return unwrapAsync(groupsRemoveGroupMembers(this, id, requestBody, options));
    }
    ...
    async updateGroup(
        ...
        return unwrapAsync(groupsUpdateGroup(this, id, requestBody, options));
    }
}
