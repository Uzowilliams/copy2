...
export class Tags extends ClientSDK {
  ...
  async createTagGroup(
    ...
    return unwrapAsync(tagsCreateTagGroup(
      this,
      request,
      options,
    ));
  ...
  async getTag(
    name: string,
    options?: RequestOptions,
  ): Promise<operations.GetTagResponseBody> {
  ...
  async getTagGroup(
    ...
    return unwrapAsync(tagsGetTagGroup(
      this,
      id,
      options,
    ));
  ...
  async listTagGroups(
    options?: RequestOptions,
  ): Promise<operations.ListTagGroupsResponseBody> {
    return unwrapAsync(tagsListTagGroups(
      this,
      options,
    ));
  }
  ...
  async listTags(
    options?: RequestOptions,
  ): Promise<operations.ListTagsResponseBody> {
  ...
  async updateTagGroup(
    ...
    return unwrapAsync(tagsUpdateTagGroup(
      this,
      id,
      requestBody,
      options,
