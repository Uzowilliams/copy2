...
export namespace CompleteExternalUploadRequestBody$ {
    ...
    export const outboundSchema = CompleteExternalUploadRequestBody$outboundSchema;
...
export namespace CompleteExternalUploadResponseBody$ {
    ...
    export const outboundSchema = CompleteExternalUploadResponseBody$outboundSchema;
