...
/** @internal */
export const GetTagRequest$inboundSchema: z.ZodType<GetTagRequest, z.ZodTypeDef, unknown> =
    z.object({
        name: z.string(),
    });
...
/** @internal */
export const GetTagTags$inboundSchema: z.ZodType<GetTagTags, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const GetTagTags$outboundSchema: z.ZodType<GetTagTags$Outbound, z.ZodTypeDef, GetTagTags> = z
    .object({
        id: z.number().int().optional(),
        name: z.string().optional(),
        staff: z.boolean().optional(),
...
/** @internal */
export const GetTagPosters$inboundSchema: z.ZodType<GetTagPosters, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const GetTagTopics$inboundSchema: z.ZodType<GetTagTopics, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const GetTagTopicList$inboundSchema: z.ZodType<GetTagTopicList, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const GetTagUsers$inboundSchema: z.ZodType<GetTagUsers, z.ZodTypeDef, unknown> = z
    .object({
