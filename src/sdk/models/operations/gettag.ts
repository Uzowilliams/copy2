...
export class GetTagTags extends SpeakeasyBase {
    @SpeakeasyMetadata()
    @Expose({ name: "id" })
    id?: number;
...
export class GetTagPosters extends SpeakeasyBase {
    @SpeakeasyMetadata()
...
export class GetTagTopics extends SpeakeasyBase {
    @SpeakeasyMetadata()
    ...
    @SpeakeasyMetadata({ elemType: GetTagPosters })
    @Expose({ name: "posters" })
    @Type(() => GetTagPosters)
    posters?: GetTagPosters[];
...
export class GetTagTopicList extends SpeakeasyBase {
    @SpeakeasyMetadata()
    ...
    @SpeakeasyMetadata({ elemType: GetTagTags })
    @Expose({ name: "tags" })
    @Type(() => GetTagTags)
    tags?: GetTagTags[];

    @SpeakeasyMetadata({ elemType: GetTagTopics })
    @Expose({ name: "topics" })
    @Type(() => GetTagTopics)
    topics?: GetTagTopics[];
}

export class GetTagUsers extends SpeakeasyBase {
    @SpeakeasyMetadata()
 ...
 * notifications
 */
export class GetTagResponseBody extends SpeakeasyBase {
    @SpeakeasyMetadata()
    ...
    @Type(() => GetTagTopicList)
    topicList?: GetTagTopicList;

    @SpeakeasyMetadata({ elemType: GetTagUsers })
    @Expose({ name: "users" })
    @Type(() => GetTagUsers)
    users?: GetTagUsers[];
}
