...
> = z.object({
  ...
  RequestBody: z.lazy(() => PerformPostActionRequestBody$inboundSchema)
    .optional(),
}).transform((v) => {
  return remap$(v, {
    "Api-Key": "apiKey",
...
> = z.object({
  ...
  requestBody: z.lazy(() => PerformPostActionRequestBody$outboundSchema)
    .optional(),
}).transform((v) => {
  return remap$(v, {
    apiKey: "Api-Key",
...
/** @internal */
export const Notice$inboundSchema: z.ZodType<Notice, z.ZodTypeDef, unknown> = z
  .object({});
...
/** @internal */
export const Notice$outboundSchema: z.ZodType<
  Notice$Outbound,
  z.ZodTypeDef,
  Notice
> = z.object({});
...
> = z.object({
  actions_summary: z.array(
    z.lazy(() => PerformPostActionActionsSummary$inboundSchema),
  ).optional(),
...
> = z.object({
  actionsSummary: z.array(
    z.lazy(() => PerformPostActionActionsSummary$outboundSchema),
  ).optional(),
  admin: z.boolean().optional(),
