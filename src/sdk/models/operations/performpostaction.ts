...
export class ActionsSummary extends SpeakeasyBase {
    @SpeakeasyMetadata()
    @Expose({ name: "acted" })
    acted?: boolean;
 ...
 * post updated
 */
export class PerformPostActionResponseBody extends SpeakeasyBase {
    @SpeakeasyMetadata({ elemType: ActionsSummary })
...
export class PerformPostActionResponse extends SpeakeasyBase {
     ...
     */
    @SpeakeasyMetadata()
    object?: PerformPostActionResponseBody;
}
