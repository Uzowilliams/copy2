...
export class ListPostsActionsSummary extends SpeakeasyBase {
    @SpeakeasyMetadata()
    @Expose({ name: "can_act" })
    canAct?: boolean;
...
export class LatestPosts extends SpeakeasyBase {
    @SpeakeasyMetadata({ elemType: ListPostsActionsSummary })
    @Expose({ name: "actions_summary" })
    @Type(() => ListPostsActionsSummary)
    actionsSummary?: ListPostsActionsSummary[];
 ...
 * latest posts
 */
export class ListPostsResponseBody extends SpeakeasyBase {
    @SpeakeasyMetadata({ elemType: LatestPosts })
