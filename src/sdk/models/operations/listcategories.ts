...
export class ListCategoriesRequest extends SpeakeasyBase {
    @SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=include_subcategories" })
 ...
 * success response
 */
export class ListCategoriesResponseBody extends SpeakeasyBase {
    @SpeakeasyMetadata()
...
export class ListCategoriesResponse extends SpeakeasyBase {
     ...
     */
    @SpeakeasyMetadata()
    object?: ListCategoriesResponseBody;
}
