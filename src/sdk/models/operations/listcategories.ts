...
/** @internal */
export const Categories$inboundSchema: z.ZodType<Categories, z.ZodTypeDef, unknown> = z
    .object({
        can_edit: z.boolean(),
        color: z.string(),
...
/** @internal */
export const Categories$outboundSchema: z.ZodType<Categories$Outbound, z.ZodTypeDef, Categories> = z
    .object({
        canEdit: z.boolean(),
        color: z.string(),
...
/** @internal */
export const CategoryList$inboundSchema: z.ZodType<CategoryList, z.ZodTypeDef, unknown> = z
    .object({
