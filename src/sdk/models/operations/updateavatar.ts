...
/** @internal */
export const UpdateAvatarType$inboundSchema: z.ZodNativeEnum<typeof UpdateAvatarType> =
    z.nativeEnum(UpdateAvatarType);

/** @internal */
export const UpdateAvatarType$outboundSchema: z.ZodNativeEnum<typeof UpdateAvatarType> =
