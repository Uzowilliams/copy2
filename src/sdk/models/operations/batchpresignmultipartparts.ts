...
export namespace BatchPresignMultipartPartsRequestBody$ {
    ...
    export const inboundSchema = BatchPresignMultipartPartsRequestBody$inboundSchema;
    /** @deprecated use `BatchPresignMultipartPartsRequestBody$outboundSchema` instead. */
    export const outboundSchema = BatchPresignMultipartPartsRequestBody$outboundSchema;
...
/** @internal */
export const PresignedUrls$inboundSchema: z.ZodType<PresignedUrls, z.ZodTypeDef, unknown> =
    z.object({});
...
export namespace BatchPresignMultipartPartsResponseBody$ {
    ...
    export const inboundSchema = BatchPresignMultipartPartsResponseBody$inboundSchema;
    /** @deprecated use `BatchPresignMultipartPartsResponseBody$outboundSchema` instead. */
    export const outboundSchema = BatchPresignMultipartPartsResponseBody$outboundSchema;
