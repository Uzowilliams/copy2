...
export class ApprovedBy extends SpeakeasyBase {
    @SpeakeasyMetadata()
...
export class AdminGetUserExternalIds extends SpeakeasyBase {}

export class AdminGetUserGroups extends SpeakeasyBase {
    @SpeakeasyMetadata()
...
export class PenaltyCounts extends SpeakeasyBase {
    @SpeakeasyMetadata()
...
export class AdminGetUserPenaltyCounts extends SpeakeasyBase {
    @SpeakeasyMetadata()
    @Expose({ name: "silenced" })
    silenced: number;
...
export class Tl3Requirements extends SpeakeasyBase {
    @SpeakeasyMetadata()
    ...
    @Type(() => AdminGetUserPenaltyCounts)
 ...
 * response
 */
export class AdminGetUserResponseBody extends SpeakeasyBase {
    @SpeakeasyMetadata()
    @Expose({ name: "active" })
    active: boolean;
    ...
    @SpeakeasyMetadata({ elemType: AdminGetUserGroups })
    @Expose({ name: "groups" })
    @Type(() => AdminGetUserGroups)
    groups: AdminGetUserGroups[];
...
export class AdminGetUserResponse extends SpeakeasyBase {
     ...
     */
    @SpeakeasyMetadata()
    object?: AdminGetUserResponseBody;
}
