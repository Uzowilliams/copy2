...
> = z
    .object({
        actions_summary: z.array(z.lazy(() => CreateTopicPostPMActionsSummary$inboundSchema)),
        admin: z.boolean(),
...
> = z
    .object({
        actionsSummary: z.array(z.lazy(() => CreateTopicPostPMActionsSummary$outboundSchema)),
        admin: z.boolean(),
