...
export class CreateTopicPostPMActionsSummary extends SpeakeasyBase {
    @SpeakeasyMetadata()
    @Expose({ name: "can_act" })
    canAct: boolean;
 ...
 * post created
 */
export class CreateTopicPostPMResponseBody extends SpeakeasyBase {
    @SpeakeasyMetadata({ elemType: CreateTopicPostPMActionsSummary })
    @Expose({ name: "actions_summary" })
    @Type(() => CreateTopicPostPMActionsSummary)
    actionsSummary: CreateTopicPostPMActionsSummary[];
...
export class CreateTopicPostPMResponse extends SpeakeasyBase {
     ...
     */
    @SpeakeasyMetadata()
    object?: CreateTopicPostPMResponseBody;
}
