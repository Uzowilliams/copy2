...
/** @internal */
export const Archetypes$inboundSchema: z.ZodType<
  Archetypes,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const Archetypes$outboundSchema: z.ZodType<
  Archetypes$Outbound,
  z.ZodTypeDef,
  Archetypes
> = z.object({
...
/** @internal */
export const GetSiteCategories$inboundSchema: z.ZodType<
  GetSiteCategories,
  z.ZodTypeDef,
  unknown
> = z.object({
  ...
  required_tag_groups: z.array(
    z.lazy(() => GetSiteRequiredTagGroups$inboundSchema),
  ),
...
> = z.object({
  ...
  requiredTagGroups: z.array(
    z.lazy(() => GetSiteRequiredTagGroups$outboundSchema),
  ),
...
/** @internal */
export const CensoredRegexp$inboundSchema: z.ZodType<
  CensoredRegexp,
  z.ZodTypeDef,
  unknown
> = z.object({});
...
/** @internal */
export const GetSiteGroups$inboundSchema: z.ZodType<
  GetSiteGroups,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const HashtagIcons$inboundSchema: z.ZodType<
  HashtagIcons,
  z.ZodTypeDef,
  unknown
> = z.object({});
...
/** @internal */
export const NotificationTypes$inboundSchema: z.ZodType<
  NotificationTypes,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const PostActionTypes$inboundSchema: z.ZodType<
  PostActionTypes,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const PostTypes$inboundSchema: z.ZodType<
  PostTypes,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const PostTypes$outboundSchema: z.ZodType<
  PostTypes$Outbound,
  z.ZodTypeDef,
  PostTypes
> = z.object({
...
/** @internal */
export const TopicFlagTypes$inboundSchema: z.ZodType<
  TopicFlagTypes,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const TrustLevels$inboundSchema: z.ZodType<
  TrustLevels,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const UserColorSchemes$inboundSchema: z.ZodType<
  UserColorSchemes,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const UserThemes$inboundSchema: z.ZodType<
  UserThemes,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const UserThemes$outboundSchema: z.ZodType<
  UserThemes$Outbound,
  z.ZodTypeDef,
  UserThemes
> = z.object({
...
/** @internal */
export const UserTips$inboundSchema: z.ZodType<
  UserTips,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const UserTips$outboundSchema: z.ZodType<
  UserTips$Outbound,
  z.ZodTypeDef,
  UserTips
> = z.object({
...
> = z.object({
  ...
  default_dark_color_scheme: z.nullable(
    z.lazy(() => DefaultDarkColorScheme$inboundSchema),
  ),
  ...
  hashtag_configurations: z.lazy(() => HashtagConfigurations$inboundSchema)
    .optional(),
  hashtag_icons: z.lazy(() => HashtagIcons$inboundSchema).optional(),
  markdown_additional_options: z.lazy(() =>
    MarkdownAdditionalOptions$inboundSchema
  ).optional(),
...
> = z.object({
  ...
  defaultDarkColorScheme: z.nullable(
    z.lazy(() => DefaultDarkColorScheme$outboundSchema),
  ),
  ...
  hashtagConfigurations: z.lazy(() => HashtagConfigurations$outboundSchema)
    .optional(),
  hashtagIcons: z.lazy(() => HashtagIcons$outboundSchema).optional(),
  markdownAdditionalOptions: z.lazy(() =>
    MarkdownAdditionalOptions$outboundSchema
  ).optional(),
