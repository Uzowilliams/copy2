...
/** @internal */
export const QueryParamAsc$inboundSchema: z.ZodNativeEnum<typeof QueryParamAsc> =
    z.nativeEnum(QueryParamAsc);

/** @internal */
export const QueryParamAsc$outboundSchema: z.ZodNativeEnum<typeof QueryParamAsc> =
...
/** @internal */
export const Flag$inboundSchema: z.ZodNativeEnum<typeof Flag> = z.nativeEnum(Flag);

/** @internal */
export const Flag$outboundSchema: z.ZodNativeEnum<typeof Flag> = Flag$inboundSchema;
...
/** @internal */
export const QueryParamOrder$inboundSchema: z.ZodNativeEnum<typeof QueryParamOrder> =
    z.nativeEnum(QueryParamOrder);

/** @internal */
export const QueryParamOrder$outboundSchema: z.ZodNativeEnum<typeof QueryParamOrder> =
