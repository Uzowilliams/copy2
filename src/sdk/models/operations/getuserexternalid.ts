...
/** @internal */
export const GetUserExternalIdUserNotificationSchedule$outboundSchema:
  z.ZodType<
...
> = z.object({
  ...
  user_auth_tokens: z.array(
    z.lazy(() => GetUserExternalIdUserAuthTokens$inboundSchema),
  ),
  user_fields: z.lazy(() => GetUserExternalIdUserFields$inboundSchema)
    .optional(),
...
> = z.object({
  ...
  userAuthTokens: z.array(
    z.lazy(() => GetUserExternalIdUserAuthTokens$outboundSchema),
  ),
  userFields: z.lazy(() => GetUserExternalIdUserFields$outboundSchema)
    .optional(),
