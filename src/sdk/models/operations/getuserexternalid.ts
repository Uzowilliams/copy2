...
export class GetUserExternalIdRequest extends SpeakeasyBase {
...
export class GetUserExternalIdCustomFields extends SpeakeasyBase {
    @SpeakeasyMetadata()
    @Expose({ name: "first_name" })
    firstName?: string;
}

export class GetUserExternalIdGroupUsers extends SpeakeasyBase {
    @SpeakeasyMetadata()
...
export class GetUserExternalIdGroups extends SpeakeasyBase {
    @SpeakeasyMetadata()
...
export class GetUserExternalIdUserAuthTokens extends SpeakeasyBase {
    @SpeakeasyMetadata()
    @Expose({ name: "browser" })
    browser: string;
...
export class GetUserExternalIdUserFields extends SpeakeasyBase {
    @SpeakeasyMetadata()
    @Expose({ name: "1" })
    one: string;
...
export class GetUserExternalIdUserNotificationSchedule extends SpeakeasyBase {
    @SpeakeasyMetadata()
...
export class GetUserExternalIdUserOption extends SpeakeasyBase {
    @SpeakeasyMetadata()
...
export class GetUserExternalIdUser extends SpeakeasyBase {
    @SpeakeasyMetadata()
    @Expose({ name: "admin" })
    admin: boolean;
    ...
    @Type(() => GetUserExternalIdCustomFields)
    ...
    @SpeakeasyMetadata({ elemType: GetUserExternalIdGroupUsers })
    @Expose({ name: "group_users" })
    @Type(() => GetUserExternalIdGroupUsers)
    groupUsers: GetUserExternalIdGroupUsers[];

    @SpeakeasyMetadata({ elemType: GetUserExternalIdGroups })
    @Expose({ name: "groups" })
    @Type(() => GetUserExternalIdGroups)
    groups: GetUserExternalIdGroups[];
    ...
    @SpeakeasyMetadata({ elemType: GetUserExternalIdUserAuthTokens })
    @Expose({ name: "user_auth_tokens" })
    @Type(() => GetUserExternalIdUserAuthTokens)
    userAuthTokens: GetUserExternalIdUserAuthTokens[];

    @SpeakeasyMetadata()
    @Expose({ name: "user_fields" })
    @Type(() => GetUserExternalIdUserFields)
    userFields?: GetUserExternalIdUserFields;

    @SpeakeasyMetadata()
    @Expose({ name: "user_notification_schedule" })
    @Type(() => GetUserExternalIdUserNotificationSchedule)
    userNotificationSchedule: GetUserExternalIdUserNotificationSchedule;

    @SpeakeasyMetadata()
    @Expose({ name: "user_option" })
    @Type(() => GetUserExternalIdUserOption)
 ...
 * user response
 */
export class GetUserExternalIdResponseBody extends SpeakeasyBase {
    @SpeakeasyMetadata()
    @Expose({ name: "user" })
    @Type(() => GetUserExternalIdUser)
...
export class GetUserExternalIdResponse extends SpeakeasyBase {
    /**
     ...
     */
    @SpeakeasyMetadata()
    object?: GetUserExternalIdResponseBody;
}
