...
> = z.object({
  ...
  group_permissions: z.array(
    z.lazy(() => GetCategoryGroupPermissions$inboundSchema),
  ),
  ...
  required_tag_groups: z.array(
    z.lazy(() => GetCategoryRequiredTagGroups$inboundSchema),
  ),
...
> = z.object({
  ...
  groupPermissions: z.array(
    z.lazy(() => GetCategoryGroupPermissions$outboundSchema),
  ),
  ...
  requiredTagGroups: z.array(
    z.lazy(() => GetCategoryRequiredTagGroups$outboundSchema),
  ),
