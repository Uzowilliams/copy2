...
/** @internal */
export const Permissions$inboundSchema: z.ZodType<Permissions, z.ZodTypeDef, unknown> =
    collectExtraKeys$(
        z
            .object({
...
/** @internal */
export const CustomFields$inboundSchema: z.ZodType<CustomFields, z.ZodTypeDef, unknown> = z.object(
    {}
);
...
/** @internal */
export const GroupPermissions$inboundSchema: z.ZodType<GroupPermissions, z.ZodTypeDef, unknown> = z
    .object({
        group_name: z.string(),
...
/** @internal */
export const RequiredTagGroups$inboundSchema: z.ZodType<RequiredTagGroups, z.ZodTypeDef, unknown> =
    z
        .object({
