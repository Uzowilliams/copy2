...
export class GroupPermissions extends SpeakeasyBase {
    @SpeakeasyMetadata()
...
export class RequiredTagGroups extends SpeakeasyBase {
    @SpeakeasyMetadata()
...
export class Category extends SpeakeasyBase {
    ...
    @SpeakeasyMetadata({ elemType: GroupPermissions })
    ...
    @SpeakeasyMetadata({ elemType: RequiredTagGroups })
    @Expose({ name: "required_tag_groups" })
    @Type(() => RequiredTagGroups)
 ...
 * success response
 */
export class CreateCategoryResponseBody extends SpeakeasyBase {
    @SpeakeasyMetadata()
...
export class CreateCategoryResponse extends SpeakeasyBase {
     ...
     */
    @SpeakeasyMetadata()
    object?: CreateCategoryResponseBody;
}
