...
/** @internal */
export const GrantedBies$inboundSchema: z.ZodType<GrantedBies, z.ZodTypeDef, unknown> = z
    .object({
        admin: z.boolean(),
...
/** @internal */
export const UserBadges$inboundSchema: z.ZodType<UserBadges, z.ZodTypeDef, unknown> = z
    .object({
...
/** @internal */
export const UserBadges$outboundSchema: z.ZodType<UserBadges$Outbound, z.ZodTypeDef, UserBadges> = z
    .object({
...
> = z
    .object({
        badge_types: z.array(z.lazy(() => ListUserBadgesBadgeTypes$inboundSchema)).optional(),
...
> = z
    .object({
        badgeTypes: z.array(z.lazy(() => ListUserBadgesBadgeTypes$outboundSchema)).optional(),
