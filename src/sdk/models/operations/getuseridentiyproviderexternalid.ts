...
export class GetUserIdentiyProviderExternalIdCustomFields extends SpeakeasyBase {
    @SpeakeasyMetadata()
    @Expose({ name: "first_name" })
    firstName?: string;
}

export class GetUserIdentiyProviderExternalIdGroupUsers extends SpeakeasyBase {
    @SpeakeasyMetadata()
...
export class GetUserIdentiyProviderExternalIdGroups extends SpeakeasyBase {
    @SpeakeasyMetadata()
...
export class GetUserIdentiyProviderExternalIdUserAuthTokens extends SpeakeasyBase {
    @SpeakeasyMetadata()
    @Expose({ name: "browser" })
    browser: string;
...
export class GetUserIdentiyProviderExternalIdUserFields extends SpeakeasyBase {
    @SpeakeasyMetadata()
    @Expose({ name: "1" })
    one: string;
...
export class GetUserIdentiyProviderExternalIdUserNotificationSchedule extends SpeakeasyBase {
    @SpeakeasyMetadata()
...
export class GetUserIdentiyProviderExternalIdUserOption extends SpeakeasyBase {
    @SpeakeasyMetadata()
...
export class GetUserIdentiyProviderExternalIdUser extends SpeakeasyBase {
    @SpeakeasyMetadata()
    @Expose({ name: "admin" })
    admin: boolean;
    ...
    @Type(() => GetUserIdentiyProviderExternalIdCustomFields)
    ...
    @SpeakeasyMetadata({ elemType: GetUserIdentiyProviderExternalIdGroupUsers })
    @Expose({ name: "group_users" })
    @Type(() => GetUserIdentiyProviderExternalIdGroupUsers)
    groupUsers: GetUserIdentiyProviderExternalIdGroupUsers[];

    @SpeakeasyMetadata({ elemType: GetUserIdentiyProviderExternalIdGroups })
    @Expose({ name: "groups" })
    @Type(() => GetUserIdentiyProviderExternalIdGroups)
    groups: GetUserIdentiyProviderExternalIdGroups[];
    ...
    @SpeakeasyMetadata({ elemType: GetUserIdentiyProviderExternalIdUserAuthTokens })
    @Expose({ name: "user_auth_tokens" })
    @Type(() => GetUserIdentiyProviderExternalIdUserAuthTokens)
    userAuthTokens: GetUserIdentiyProviderExternalIdUserAuthTokens[];

    @SpeakeasyMetadata()
    @Expose({ name: "user_fields" })
    @Type(() => GetUserIdentiyProviderExternalIdUserFields)
    userFields?: GetUserIdentiyProviderExternalIdUserFields;

    @SpeakeasyMetadata()
    @Expose({ name: "user_notification_schedule" })
    @Type(() => GetUserIdentiyProviderExternalIdUserNotificationSchedule)
    userNotificationSchedule: GetUserIdentiyProviderExternalIdUserNotificationSchedule;

    @SpeakeasyMetadata()
    @Expose({ name: "user_option" })
    @Type(() => GetUserIdentiyProviderExternalIdUserOption)
 ...
 * user response
 */
export class GetUserIdentiyProviderExternalIdResponseBody extends SpeakeasyBase {
    @SpeakeasyMetadata()
    @Expose({ name: "user" })
    @Type(() => GetUserIdentiyProviderExternalIdUser)
...
export class GetUserIdentiyProviderExternalIdResponse extends SpeakeasyBase {
     ...
     */
    @SpeakeasyMetadata()
    object?: GetUserIdentiyProviderExternalIdResponseBody;
}
