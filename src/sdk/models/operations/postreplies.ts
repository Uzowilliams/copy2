...
export class PostRepliesActionsSummary extends SpeakeasyBase {
    @SpeakeasyMetadata()
    @Expose({ name: "can_act" })
    canAct: boolean;
...
export class ReplyToUser extends SpeakeasyBase {
    @SpeakeasyMetadata()
...
export class PostRepliesResponseBody extends SpeakeasyBase {
    @SpeakeasyMetadata({ elemType: PostRepliesActionsSummary })
    @Expose({ name: "actions_summary" })
    @Type(() => PostRepliesActionsSummary)
    actionsSummary: PostRepliesActionsSummary[];
...
export class PostRepliesResponse extends SpeakeasyBase {
     ...
     * post replies
     */
    @SpeakeasyMetadata({ elemType: PostRepliesResponseBody })
    responseBodies?: PostRepliesResponseBody[];
}
