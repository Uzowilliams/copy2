...
export class CreateBadgeBadgeTypes extends SpeakeasyBase {
    @SpeakeasyMetadata()
    @Expose({ name: "id" })
    id: number;
 ...
 * success response
 */
export class CreateBadgeResponseBody extends SpeakeasyBase {
    @SpeakeasyMetadata()
    @Expose({ name: "badge" })
    @Type(() => Badge)
    badge: Badge;

    @SpeakeasyMetadata({ elemType: CreateBadgeBadgeTypes })
    @Expose({ name: "badge_types" })
    @Type(() => CreateBadgeBadgeTypes)
    badgeTypes: CreateBadgeBadgeTypes[];
}
...
export class CreateBadgeResponse extends SpeakeasyBase {
     ...
     */
    @SpeakeasyMetadata()
    object?: CreateBadgeResponseBody;
}
