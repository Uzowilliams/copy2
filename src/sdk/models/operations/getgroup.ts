...
/** @internal */
export const GetGroupRequest$inboundSchema: z.ZodType<GetGroupRequest, z.ZodTypeDef, unknown> =
    z.object({
        id: z.string(),
    });
...
/** @internal */
export const Extras$outboundSchema: z.ZodType<Extras$Outbound, z.ZodTypeDef, Extras> = z
    .object({
...
/** @internal */
export const ImapUpdatedBy$inboundSchema: z.ZodType<ImapUpdatedBy, z.ZodTypeDef, unknown> =
    z.object({});
...
/** @internal */
export const SmtpUpdatedBy$inboundSchema: z.ZodType<SmtpUpdatedBy, z.ZodTypeDef, unknown> =
    z.object({});
...
/** @internal */
export const GetGroupGroup$inboundSchema: z.ZodType<GetGroupGroup, z.ZodTypeDef, unknown> = z
    .object({
        ...
        imap_updated_by: z.nullable(z.lazy(() => ImapUpdatedBy$inboundSchema)).optional(),
        ...
        smtp_updated_by: z.nullable(z.lazy(() => SmtpUpdatedBy$inboundSchema)).optional(),
...
> = z
    .object({
        ...
        imapUpdatedBy: z.nullable(z.lazy(() => ImapUpdatedBy$outboundSchema)).optional(),
        ...
        smtpUpdatedBy: z.nullable(z.lazy(() => SmtpUpdatedBy$outboundSchema)).optional(),
        title: z.nullable(z.string()),
