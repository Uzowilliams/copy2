...
export class ImapUpdatedBy extends SpeakeasyBase {}

export class SmtpUpdatedBy extends SpeakeasyBase {}

export class GetGroupGroup extends SpeakeasyBase {
    @SpeakeasyMetadata()
 ...
 * success response
 */
export class GetGroupResponseBody extends SpeakeasyBase {
    @SpeakeasyMetadata()
    @Expose({ name: "extras" })
    @Type(() => Extras)
    extras: Extras;
