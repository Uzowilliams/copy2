...
> = z.object({
  ...
  posters: z.array(z.lazy(() => ListLatestTopicsPosters$inboundSchema))
    .optional(),
...
> = z.object({
  ...
  posters: z.array(z.lazy(() => ListLatestTopicsPosters$outboundSchema))
    .optional(),
...
> = z.object({
  ...
  topics: z.array(z.lazy(() => ListLatestTopicsTopics$inboundSchema))
    .optional(),
}).transform((v) => {
  return remap$(v, {
...
> = z.object({
  ...
  topics: z.array(z.lazy(() => ListLatestTopicsTopics$outboundSchema))
    .optional(),
}).transform((v) => {
  return remap$(v, {
