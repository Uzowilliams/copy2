...
/** @internal */
export const GetTopicRequest$inboundSchema: z.ZodType<
  GetTopicRequest,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const LastPoster$inboundSchema: z.ZodType<
  LastPoster,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const LastPoster$outboundSchema: z.ZodType<
  LastPoster$Outbound,
  z.ZodTypeDef,
  LastPoster
> = z.object({
...
/** @internal */
export const LinkCounts$inboundSchema: z.ZodType<
  LinkCounts,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const LinkCounts$outboundSchema: z.ZodType<
  LinkCounts$Outbound,
  z.ZodTypeDef,
  LinkCounts
> = z.object({
...
export const Posts$inboundSchema: z.ZodType<Posts, z.ZodTypeDef, unknown> = z
  .object({
    actions_summary: z.array(
      z.lazy(() => GetTopicTopicsActionsSummary$inboundSchema),
    ),
    admin: z.boolean(),
    avatar_template: z.string(),
...
/** @internal */
export const Posts$outboundSchema: z.ZodType<
  Posts$Outbound,
  z.ZodTypeDef,
  Posts
> = z.object({
  actionsSummary: z.array(
    z.lazy(() => GetTopicTopicsActionsSummary$outboundSchema),
  ),
  admin: z.boolean(),
  avatarTemplate: z.string(),
  bookmarked: z.boolean(),
...
/** @internal */
export const PostStream$inboundSchema: z.ZodType<
  PostStream,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const PostStream$outboundSchema: z.ZodType<
  PostStream$Outbound,
  z.ZodTypeDef,
  PostStream
> = z.object({
...
/** @internal */
export const GetTopicUser$inboundSchema: z.ZodType<
  GetTopicUser,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const Posters$inboundSchema: z.ZodType<Posters, z.ZodTypeDef, unknown> =
  z.object({
...
/** @internal */
export const Posters$outboundSchema: z.ZodType<
  Posters$Outbound,
  z.ZodTypeDef,
  Posters
> = z.object({
...
/** @internal */
export const SuggestedTopics$inboundSchema: z.ZodType<
  SuggestedTopics,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const TagsDescriptions$inboundSchema: z.ZodType<
  TagsDescriptions,
  z.ZodTypeDef,
  unknown
> = z.object({});
