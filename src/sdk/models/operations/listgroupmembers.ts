...
/** @internal */
export const Members$inboundSchema: z.ZodType<Members, z.ZodTypeDef, unknown> = z
    .object({
        added_at: z.string(),
...
/** @internal */
export const Members$outboundSchema: z.ZodType<Members$Outbound, z.ZodTypeDef, Members> = z
    .object({
        addedAt: z.string(),
...
/** @internal */
export const Owners$outboundSchema: z.ZodType<Owners$Outbound, z.ZodTypeDef, Owners> = z
    .object({
        addedAt: z.string(),
        avatarTemplate: z.string(),
        id: z.number().int(),
