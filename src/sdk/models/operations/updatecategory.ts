...
> = z.object({
  ...
  permissions: z.lazy(() => UpdateCategoryPermissions$outboundSchema)
    .optional(),
...
> = z.object({
  ...
  group_permissions: z.array(
    z.lazy(() => UpdateCategoryGroupPermissions$inboundSchema),
  ),
  ...
  required_tag_groups: z.array(
    z.lazy(() => UpdateCategoryRequiredTagGroups$inboundSchema),
  ),
...
> = z.object({
  ...
  groupPermissions: z.array(
    z.lazy(() => UpdateCategoryGroupPermissions$outboundSchema),
  ),
  ...
  requiredTagGroups: z.array(
    z.lazy(() => UpdateCategoryRequiredTagGroups$outboundSchema),
  ),
